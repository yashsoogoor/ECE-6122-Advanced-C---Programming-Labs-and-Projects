...
Description :
This file sets up the framework and functions for creating, manipulating, and rendering the Suzanne objects. 
...
//Function to create and render objects and toggle light; returns 0 upon completion
...
int main( void )
{
	...
	{
		-3.0f, -3.0f, 0.0f,  // Vertex 1 
		 3.0f,  3.0f, 0.0f,  // Vertex 3 
		-3.0f,  3.0f, 0.0f,  // Vertex 4
	};
	...
	do{
		...
		ModelMatrix1 = glm::translate(ModelMatrix1, glm::vec3(1.90f, 0.0f, 0.98f));
		...
		ModelMatrix2 = glm::rotate(ModelMatrix2, glm::radians(90.0f), glm::vec3(0.0, 0.0f, 1.0f));
		//ModelMatrix2 = glm::translate(ModelMatrix2, glm::vec3(0.0f,0.00f, 0.0f));
		ModelMatrix2 = glm::translate(ModelMatrix2, glm::vec3(1.90f, 0.0f, 0.98f));
		...
		ModelMatrix3 = glm::rotate(ModelMatrix3, glm::radians(180.0f), glm::vec3(0.0, 0.0f, 1.0f));
		//ModelMatrix3 = glm::translate(ModelMatrix3, glm::vec3(0.0f, 5.0f, 0.0f));
		ModelMatrix3 = glm::translate(ModelMatrix3, glm::vec3(1.90f, 0.0f, 0.98f));
		ModelMatrix3 = glm::rotate(ModelMatrix3, glm::radians(90.0f), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		ModelMatrix4 = glm::rotate(ModelMatrix4, glm::radians(270.0f), glm::vec3(0.0, 0.0f, 1.0f));
		//ModelMatrix3 = glm::translate(ModelMatrix3, glm::vec3(0.0f, 5.0f, 0.0f));
		ModelMatrix4 = glm::translate(ModelMatrix4, glm::vec3(1.90f, 0.0f, 0.98f));
