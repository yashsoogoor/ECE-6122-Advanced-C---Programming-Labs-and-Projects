...
Description :
This file sets up the keyboard controls for the animated scene application which contains Suzanne heads that float around when the user chooses. 
...
float PI = 3.14f;
float deltaTheta = 0.0005f * PI; 
float deltaPhi = 0.0005f * PI; 
